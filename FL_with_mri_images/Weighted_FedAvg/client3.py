...
edsd = available_datasets.load_EDSD_data(x_range_from = 32, x_range_to = 161,
                                         ...
                                         flavor = flavor)
edsd_images = edsd['images']
edsd_labels = edsd['labels']
edsd_labels = to_categorical(edsd_labels)

# Split the data into training and testing set
X_train, X_test, Y_train, Y_test = train_test_split(edsd_images, edsd_labels, test_size=0.2, random_state=42)
...
class EDSD_Client(fl.client.NumPyClient):
...
model = util.DenseNet(edsd_images.shape[1:], edsd_labels.shape[1])

# Start Flower client
client = EDSD_Client(model, X_train, Y_train, X_test, Y_test)
